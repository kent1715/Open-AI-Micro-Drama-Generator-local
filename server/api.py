...
async def log_startup_config():
    print(f"[Startup] VIDEO_PROVIDER={os.environ.get('VIDEO_PROVIDER', 'muapi')}")
    print(f"[Startup] LOCAL_VIDEO_BACKEND={os.environ.get('LOCAL_VIDEO_BACKEND', 'wangp')}")
    print(f"[Startup] LOCAL_VIDEO_BASE_URL={os.environ.get('LOCAL_VIDEO_BASE_URL', 'http://127.0.0.1:7860')}")
    print(f"[Startup] LOCAL_VIDEO_DUMMY_ON_FAILURE={os.environ.get('LOCAL_VIDEO_DUMMY_ON_FAILURE', 'true')}")
